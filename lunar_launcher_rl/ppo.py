...
class PPO:
    def __init__(self, agent: PlayerAgent, lr, betas, gamma, K_epochs, eps_clip, device="cpu"):
        self.lr = lr
        self.betas = betas
        self.gamma = gamma
        ...
        self.policy = agent.create_policy()

        # print(self.policy.parameters())
        self.optimizer = torch.optim.Adam(self.policy.parameters(), lr=lr, betas=betas)

        self.agent = agent
        self.agent.policy.load_state_dict(self.policy.state_dict())
